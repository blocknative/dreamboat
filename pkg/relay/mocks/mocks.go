...
// Source: github.com/blocknative/dreamboat/pkg/relay (interfaces: Datastore,State,ValidatorStore,ValidatorCache,BlockValidationClient,DataAPIStore)
...
func (m *MockDataAPIStore) CheckSlotDelivered(arg0 context.Context, arg1 uint64) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataAPIStoreMockRecorder) CheckSlotDelivered(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckSlotDelivered", reflect.TypeOf((*MockDataAPIStore)(nil).CheckSlotDelivered), arg0, arg1)
}
...
func (m *MockDataAPIStore) PutBuilderBlockSubmission(arg0 context.Context, arg1 structs.HeaderData, arg2 bool) error {
	m.ctrl.T.Helper()
