...
// Source: github.com/blocknative/dreamboat/pkg/relay (interfaces: Datastore,State,ValidatorStore,ValidatorCache,BlockValidationClient,Streamer)
...
// PublishCacheBlock mocks base method.
func (m *MockStreamer) PublishCacheBlock() chan structs.BlockAndTrace {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishCacheBlock")
	ret0, _ := ret[0].(chan structs.BlockAndTrace)
	return ret0
}

// PublishCacheBlock indicates an expected call of PublishCacheBlock.
func (mr *MockStreamerMockRecorder) PublishCacheBlock() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishCacheBlock", reflect.TypeOf((*MockStreamer)(nil).PublishCacheBlock))
}

// PublishStoreBlock mocks base method.
func (m *MockStreamer) PublishStoreBlock() chan structs.BlockAndTrace {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishStoreBlock")
	ret0, _ := ret[0].(chan structs.BlockAndTrace)
	return ret0
}

// PublishStoreBlock indicates an expected call of PublishStoreBlock.
func (mr *MockStreamerMockRecorder) PublishStoreBlock() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishStoreBlock", reflect.TypeOf((*MockStreamer)(nil).PublishStoreBlock))
}
