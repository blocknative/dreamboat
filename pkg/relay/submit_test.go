...
func TestSubmitBlock(t *testing.T) {
	...
	r := relay.NewRelay(l, config, nil, vCache, vStore, ver, bs, ds, ds, auction.NewAuctioneer(), bVCli, nil)
...
func TestSubmitBlockInvalidTimestamp(t *testing.T) {
	...
	r := relay.NewRelay(l, config, nil, nil, nil, ver, bs, ds, ds, auction.NewAuctioneer(), bVCli, nil)
