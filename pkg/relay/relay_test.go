...
func TestGetHeader(t *testing.T) {
	...
	ver.RunVerify(300)
	r := relay.NewRelay(log.New(), config, nil, nil, nil, ver, bs, ds, ds, a, nil, nil)
	require.NoError(t, err)
...
func TestGetPayload(t *testing.T) {
	...
	r := relay.NewRelay(l, config, nil, nil, nil, ver, bs, ds, ds, auction.NewAuctioneer(), nil, nil)
...
func BenchmarkGetHeader(b *testing.B) {
	...
	r := relay.NewRelay(log.New(), config, nil, nil, nil, ver, bs, ds, ds, auction.NewAuctioneer(), nil, nil)
