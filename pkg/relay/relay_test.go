...
func TestGetHeader(t *testing.T) {
	...
	ver.RunVerify(300)
	r := relay.NewRelay(log.New(), config, nil, nil, nil, ver, bs, ds, a, nil, nil)
	require.NoError(t, err)
...
func TestGetPayload(t *testing.T) {
	...
	r := relay.NewRelay(l, config, nil, nil, nil, ver, bs, ds, auction.NewAuctioneer(), nil, nil)
...
func BenchmarkGetHeader(b *testing.B) {
	...
	r := relay.NewRelay(log.New(), config, nil, nil, nil, ver, bs, ds, auction.NewAuctioneer(), nil, nil)
