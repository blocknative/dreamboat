...
// Source: github.com/blocknative/dreamboat/pkg/validators (interfaces: RegistrationStore,RegistrationManager,Verifier,State)
...
func (m *MockRegistrationManager) Get(arg0 string) (uint64, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockRegistrationManagerMockRecorder) Get(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockRegistrationManager)(nil).Get), arg0)
}
